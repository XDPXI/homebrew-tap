class Sponge < Formula
  ...
  on_macos do
    on_intel do
      url "http://cdn.xdpxi.net/sponge/#{version}/sponge-#{version}-macos-x86_64.tar.gz",
          verified: "cdn.xdpxi.net"
      sha256 "929299A971A42EE7599FD0F0BFCAD7E2A5AAA268F48185B86B48EDDF2F364287"
    end

    on_arm do
      url "http://cdn.xdpxi.net/sponge/#{version}/sponge-#{version}-macos-aarch64.tar.gz",
          verified: "cdn.xdpxi.net"
  ...
  on_linux do
    on_intel do
      url "http://cdn.xdpxi.net/sponge/#{version}/sponge-#{version}-linux-x86_64.tar.gz",
          verified: "cdn.xdpxi.net"
